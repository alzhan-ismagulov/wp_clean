...
if ( ! function_exists( 'clean_setup' ) ) :
	...
	function clean_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Header_menu', 'clean' ),
		) );
...
function clean_scripts() {
    ...
    wp_enqueue_script( 'clean-jquery-waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array('jquery'), '', true);
